...
def test_add_incorrect(matrix1, matrix5):
    with Mat_test_1.raises(IncorrectMatrixSize, match="Размер матрицы справа должен быть 4 x 4"):
        matrix1 + matrix5
...
def test_mul_incorrect(matrix1, matrix5):
    with Mat_test_1.raises(IncorrectMatrixSize, match="Количество столбцов матрицы справа должно быть 4"):
        matrix1 * matrix5
